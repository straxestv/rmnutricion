...
export default function PlaceOrderScreen() {
  ...
  return (
    <div>
      ...
      <h1 className="my-3">Datos de la compra</h1>
      <Row>
        <Col md={8}>
          <Card className="mb-3 classss">
            <Card.Body>
          ...
          <Card className="mb-3">
            <Card.Body>
              <Card.Title className='classss '>Items</Card.Title>
                  ...
                  <ListGroup.Item key={item._id}>
                    <Row className="align-items-center  ">
                      <Col md={6}>
                        ...
                        ></img>{' '}
                        <Link  className='tect' to={`/product/${item.slug}`}>{item.name}</Link>
                      </Col>
                      <Col md={3}>
